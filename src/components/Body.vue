...
export default defineComponent({
  ...
  setup() {
    ...
    const getActiveMemo = store.getActiveMemo;
    const getDoneMemo = store.getDoneMemo;
    const getLoading = store.getLoading;

    // Equivalent of your mapActions
    const addMemo = store.addMemo;
    const toggleMemo = store.toggleMemo;
